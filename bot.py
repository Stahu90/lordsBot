...
class Bot_1:
    def __init__(self, player: str, purpose, kor: int):
        ...
        win32gui.MoveWindow(self.win.hwnd, 0, 0, int(win32api.GetSystemMetrics(0) / 2),
    ...
    def find(self):
        ...
        if self.x > self.x_max:
            ...
            pyautogui.moveTo(int(win32api.GetSystemMetrics(0) / 2 / 2 + win32api.GetSystemMetrics(0) / 2 / 2 / 100 * 85),
                int(win32api.GetSystemMetrics(1) / 2 / 2))
            pyautogui.dragTo(
                int(win32api.GetSystemMetrics(0) / 2 / 2 - win32api.GetSystemMetrics(0) / 2 / 2 / 100 * 90),
                int(win32api.GetSystemMetrics(1) / 2 / 2), duration=0.4)
    ...
    def open_find_win(self):
        pyautogui.moveTo(int(win32api.GetSystemMetrics(0) / 2 / 2),
    ...
    def change_y(self, y):
        ...
        pyautogui.moveTo(int(
            win32api.GetSystemMetrics(0) / 2 / 2 + win32api.GetSystemMetrics(0) / 2 / 2 - win32api.GetSystemMetrics(
                0) / 2 / 2 / 100 * 80),
            int(win32api.GetSystemMetrics(1) / 2) - int(win32api.GetSystemMetrics(1) / 2) / 100 * 60)
        pyautogui.click()
...
class Bot_2:
    def __init__(self, player: str, purpose, kor: int):
        self.win = window.Window(player)
        win32gui.MoveWindow(self.win.hwnd, int(win32api.GetSystemMetrics(0) / 2), 0, int(win32api.GetSystemMetrics(0) / 2),
                            int(win32api.GetSystemMetrics(1) / 2), True)
    ...
    def find(self):
        ...
        if self.x < self.x_max:
            pyautogui.moveTo(
                int(win32api.GetSystemMetrics(0) / 2 * 1.92),
                int(win32api.GetSystemMetrics(1) / 2 / 2))
            pyautogui.dragTo(
                int(win32api.GetSystemMetrics(0) / 2 * 1.02),
                int(win32api.GetSystemMetrics(1) / 2 / 2), duration=0.4)
    ...
    def open_find_win(self):
        pyautogui.moveTo(int(win32api.GetSystemMetrics(0) / 2 * 1.5),
                         int(win32api.GetSystemMetrics(1) / 2) - int(win32api.GetSystemMetrics(1) / 2) / 100 * 82)
        pyautogui.click()
    ...
    def change_y(self, y):
        # y
        pyautogui.moveTo(int(
            win32api.GetSystemMetrics(0) / 2 * 1.5 + win32api.GetSystemMetrics(0) / 2 * 1.5 - win32api.GetSystemMetrics(
                0) / 2 * 1.5 / 100 * 94),
            int(win32api.GetSystemMetrics(1) / 2) - int(win32api.GetSystemMetrics(1) / 2) / 100 * 60)
        pyautogui.click()
    ...
    def click_1(self):
        pyautogui.moveTo(int(
            win32api.GetSystemMetrics(0) / 2 * 1.65),
            int(win32api.GetSystemMetrics(1) / 2) - int(win32api.GetSystemMetrics(1) / 2) / 100 * 57)
        pyautogui.click()

    def click_2(self):
        pyautogui.moveTo(int(
            win32api.GetSystemMetrics(0) / 2 * 1.70),
            int(win32api.GetSystemMetrics(1) / 2) - int(win32api.GetSystemMetrics(1) / 2) / 100 * 57)
        pyautogui.click()

    def click_3(self):
        pyautogui.moveTo(int(
            win32api.GetSystemMetrics(0) / 2 * 1.77),
            int(win32api.GetSystemMetrics(1) / 2) - int(win32api.GetSystemMetrics(1) / 2) / 100 * 57)
        pyautogui.click()
    ...
    def click_ok(self):
        pyautogui.moveTo(int(
            win32api.GetSystemMetrics(0) / 2 * 1.75),
            int(win32api.GetSystemMetrics(1) / 2) - int(win32api.GetSystemMetrics(1) / 2) / 100 * 32)
        pyautogui.click()
...
class Bot_3:
    def __init__(self, player: str, purpose, kor: int):
        self.win = window.Window(player)
        win32gui.MoveWindow(self.win.hwnd, 0, int(win32api.GetSystemMetrics(1) / 2), int(win32api.GetSystemMetrics(0) / 2),
                            int(win32api.GetSystemMetrics(1) / 2), True)
...
class Bot_4:
    def __init__(self, player: str, purpose, kor: int):
        self.win = window.Window(player)
        win32gui.MoveWindow(self.win.hwnd, int(win32api.GetSystemMetrics(0) / 2), int(win32api.GetSystemMetrics(1) / 2), int(win32api.GetSystemMetrics(0) / 2),
                            int(win32api.GetSystemMetrics(1) / 2), True)
    ...
    def open_find_win(self):
        pyautogui.moveTo(int(win32api.GetSystemMetrics(0) / 2 * 1.5),
                         int(win32api.GetSystemMetrics(1) / 2 * 1.175))
        pyautogui.click()
    ...
    def click_1(self):
        pyautogui.moveTo(int(
            win32api.GetSystemMetrics(0) / 2 * 1.65),
                         int(win32api.GetSystemMetrics(1) / 2 * 1.43))
        pyautogui.click()
    ...
    def click_0(self):
        pyautogui.moveTo(int(
            win32api.GetSystemMetrics(0) / 2 * 1.66),
                         int(win32api.GetSystemMetrics(1) / 2 * 1.68))
        pyautogui.click()
